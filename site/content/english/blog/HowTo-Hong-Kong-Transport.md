---
date: "2025-09-27"
title: "Hong Kong transport guide"
...
**Route:** Hong Kong International Airport to Central / Hong Kong Station  
**Best option:** Airport Express.  
**Typical duration:** MTR says the Airport Express takes as little as 24 minutes between the airport and the Central business hub.  
**Departure point:** Airport Station.  
**Arrival point:** Hong Kong Station, with onward MTR connections.  
**Booking method:** Ticket machine, customer service centre, online ticket, Octopus or supported contactless/QR methods.  
**Important notes:** If you stay in Kowloon or Tsim Sha Tsui, compare Airport Express plus transfer with direct airport buses.

**Route:** Hong Kong International Airport to Kowloon / Tsim Sha Tsui  
**Best option:** Airport Express to Kowloon plus transfer, or direct airport bus if the route stops near your hotel.  
**Typical duration:** Airport Express is faster on rail time; buses can be simpler door-to-door if traffic is acceptable.  
**Departure point:** Airport Station or airport bus terminus.  
**Arrival point:** Kowloon Station, Tsim Sha Tsui, Jordan, Mong Kok or hotel area.  
**Booking method:** Octopus, ticket machine, online Airport Express ticket or bus fare.  
**Important notes:** Airport buses are useful with luggage because they avoid some MTR transfers.

**Route:** Airport to Tung Chung / Lantau  
**Best option:** Bus, taxi or route via Tung Chung depending on destination.  
**Typical duration:** Varies by destination and traffic.  
**Departure point:** Airport bus area or taxi stand.  
**Arrival point:** Tung Chung, hotel or Lantau point.  
**Booking method:** Octopus/contactless where accepted or cash as required.  
**Important notes:** Lantau routes can be slower but direct.

## MTR

The MTR is the default for Hong Kong Island, Kowloon, Tsuen Wan, Sha Tin, Tung Chung, Disneyland, the airport link and the West Kowloon high-speed rail area. Use the official MTR site or app for line status and exits; choosing the right exit saves time in dense districts.

Payment options include Octopus, single-journey tickets and selected QR/contactless bank-card gates. Contactless gates are not always every gate, so look for the marked readers. If you use a bank card or phone, use the same card/device to enter and exit.

Key visitor stations:

| Station | Use |
| --- | --- |
| Central / Hong Kong | Central, Airport Express, ferries, The Peak access |
| Tsim Sha Tsui / East Tsim Sha Tsui | Kowloon waterfront, museums, Star Ferry |
| Mong Kok | Markets, food, shopping streets |
| Sham Shui Po | Markets, electronics, older Kowloon streets |
| Tung Chung | Lantau, Ngong Ping 360, airport bus connections |
...
- [MTR - Airport Express](https://www.mtr.com.hk/en/customer/services/airport_express_index.html): airport rail route and 24-minute city link.
- [MTR - tickets and fares](https://www.mtr.com.hk/en/customer/tickets/tf_index.html): Octopus, QR and contactless payment context.
- [Hong Kong Tourism Board - getting around](https://www.discoverhongkong.com/eng/travel-guide/traveller-essentials/getting-around.html): HKeMobility, tram, taxi and public-transport overview.
- [Hong Kong Transport Department - ferries](https://www.td.gov.hk/en/transport_in_hong_kong/public_transport/ferries/): ferry-service context and Star Ferry routes.
- [Hong Kong Transport Department - tourist routes](https://www.td.gov.hk/en/transport_in_hong_kong/trts/hkikln/index.html): Dragon's Back and Hong Kong Island bus route context.
