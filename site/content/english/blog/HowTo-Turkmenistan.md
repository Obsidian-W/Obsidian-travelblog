...
description: "My tips for visiting Turkmenistan."
...
The LOI is the key document: without it, no visa.
...
No one can really tell the price, rules keep changing, and the price might actually come down to your face rather than nationality.
...
In total, I gave 100$ with a clean bill (Important!)
...
Obviously, that's the one I used.
...
> Why? It's an uncommon route, drivers know you'll be pressed by time, they can 
