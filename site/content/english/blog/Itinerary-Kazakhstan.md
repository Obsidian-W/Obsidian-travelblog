---
date: "2025-07-01"
title: "Twelve days across Kazakhstan"
description: "A twelve-day Kazakhstan itinerary from Aktau to Almaty, through Mangystau and Astana."
image: "images/blog/mangystau.jpg"
itinerary_map: "/images/itineraries/kazakhstan.svg"
categories: ["Itinerary", "Kazakhstan", "Central Asia"]
continents: ["Asia"]
draft: true
---
...
### Two days for the canyons and lakes

I did **Charyn Canyon and the Kolsai Lakes in one day**. It works, but it rushes two places that deserve more than a sequence of photo stops. If I were planning it again, I would use two days around Almaty: one for Charyn, then one for Kolsai and Kaindy. It is the better version if you have the time.

### Burabay from Astana

**Burabay** is a possible extra day trip from Astana for lakes, forest and rock formations; [Visit Astana lists it as a one-day excursion](https://visitastana.kz/en/weekend-tours/one-day-tour-to-burabay/). I did not go, so I cannot give you the same firsthand detail as for Aqmola and Alzhir. It is far enough away that this will be a long day; an overnight stay is the less rushed option.

### Turkestan—mostly if you skip Uzbekistan

**Turkestan** is the other obvious addition. I considered it and skipped it because I was continuing into Uzbekistan. From what I found while planning, it looked too similar to the Silk Road architecture waiting later in my trip, and the detour was not worth it in that context. If Kazakhstan is your only Central Asian country, or you are not going to Uzbekistan, the calculation changes and Turkestan makes much more sense.
